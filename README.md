...
<sub><b>left:</b> what the car sees &nbsp;·&nbsp; <b>middle:</b> the frame round-tripped through <b>V</b> (VAE) &nbsp;·&nbsp; <b>right:</b> the next frame as <b>M</b> (MDN-RNN) predicts it, one step ahead — an episode driven by <code>controller-controller-2</code></sub>
